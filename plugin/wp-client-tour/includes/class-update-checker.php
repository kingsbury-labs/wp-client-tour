...
class WCT_Update_Checker {
	...
	public static function maybe_show_notice(): void {
		...
		printf(
			...
			esc_html__( 'WP Client Tour update available', 'kingsbury-client-tour' ),
			esc_html__( 'A new version is available on GitHub:', 'kingsbury-client-tour' ),
			esc_url( $release['html_url'] ),
			esc_html__( 'Download', 'kingsbury-client-tour' ),
			esc_html( $latest )
		);
	}
